...
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN', 'MTQ3MTE2MDQxOTYyMzI0NDAyOA.GusdiL.ubyn6SOREPV-dBotjg3t4vXIqSXNPwKhXJEnwQ')
BOT_NAME = os.getenv('BOT_NAME', 'PheonixHost')
PREFIX = os.getenv('PREFIX', '!')
YOUR_SERVER_IP = os.getenv('YOUR_SERVER_IP', '127.0.0.1')
MAIN_ADMIN_ID = int(os.getenv('MAIN_ADMIN_ID', '1408851223834132564'))
VPS_USER_ROLE_ID = int(os.getenv('VPS_USER_ROLE_ID', '1474352361727328380'))
DEFAULT_STORAGE_POOL = os.getenv('DEFAULT_STORAGE_POOL', 'default')
BOT_VERSION = os.getenv('BOT_VERSION', '4.0')
BOT_DEVELOPER = os.getenv('BOT_DEVELOPER', 'ZenseiTech')
...
async def delete_vps(ctx, user: discord.Member, vps_number: int, *, reason: str = "No reason"):
    ...
    # 4️⃣ Success embed
    embed = create_success_embed("🌟 Zycron - VPS Deleted Successfully")
...
async def user_info(ctx, user: discord.Member):
    ...
    embed.set_footer(text="Zycron • User Resource Dashboard")
    embed.timestamp = ctx.message.created_at
...
async def server_stats(ctx):
    ...
    embed.set_footer(text="Zycron • Real-Time Monitoring")
    embed.timestamp = ctx.message.created_at
...
async def node_cmd(ctx, sub: str, *args):
    ...
    # NEW: Add delete subcommand
        ...
        # Confirm deletion
        embed = create_warning_embed("⚠️ Delete Node", 
